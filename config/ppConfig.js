 ...
 */
 ...
 //store inside session cuz i told it to
 //store user.id inside the session so we can retrieve it for future use
 //serialize only called once
 ...
 */
 ...
 //deserialize is called everytime when you visited a page
passport.deserializeUser(function(id, done) { //id unique identifier and look for the user with this id
  //match the id and find the user in database
